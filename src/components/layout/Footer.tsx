...
const sections: Section[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { name: 'Doc', href: '/docs', icon: FOOTER_ICONS.quickLinks } // Updated href to /docs and removed type: 'route' as Footer doesn't handle it this way
    ]
  },
  {
    id: 'contact',
...
const Footer = () => {
  ...
  const handleNavigation = (link: LinkItem) => {
    if (link.href.startsWith('#')) {
      ...
      // Handle route links
      // This logic might need refinement depending on how routing is handled outside the Footer
      // For now, navigate directly or use window.location for simplicity if not using react-router-dom for these links
        ...
        return (
          <div className="text-center transform transition-all duration-500">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-6 max-w-3xl mx-auto">
              {section.links?.map((link, index) => { // Added optional chaining
        ...
        return (
          <div className="text-center transform transition-all duration-500">
            ...
            <div className="space-y-6 max-w-2xl mx-auto">
              {section.contacts?.map((contact, index) => ( // Added optional chaining
                <div
                  key={index}
                ...
                >
                  {contact.isCustomIcon ? (
                    <FooterIcon src={contact.icon as string} alt={contact.text} className="text-3xl" /> // Added type assertion
                  ) : (
        ...
        return (
          <div className="text-center transform transition-all duration-500">
            ...
            <div className="flex justify-center space-x-6">
              {section.socials?.map((social, index) => ( // Added optional chaining
                <a
                  key={index}
                  href="https://x.com/Nikitsglost5" // Hardcoded Twitter link, should be dynamic from social item
